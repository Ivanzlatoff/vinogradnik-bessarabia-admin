    ...
    <div className="topbar">
      <div className="topbarWrapper">
        ...
        <div className="topRight">
          ...
          <img src="https://firebasestorage.googleapis.com/v0/b/vb-react-ecommerce-app.appspot.com/o/grape-icon.png?alt=media&token=1a844197-58a8-4d95-b5a1-de50ff6f73c6" alt="" className="topAvatar" />
        </div>
      </div>
    </div>
  );
