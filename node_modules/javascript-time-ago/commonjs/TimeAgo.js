...
var _approximate = _interopRequireDefault(require("./style/approximate"));
...
function () {
  ...
  _createClass(TimeAgo, [{
    ...
    value: function format(input) {
      var style = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _approximate.default;
      ...
      style.gradation || style.steps || _approximate.default.gradation, secondsPassed, {
        now: now,
        units: units,
        future: future,
        getNextStep: true
      ...
      if (options.getTimeToNextUpdate) {
        var timeToNextUpdate = step && (0, _getTimeToNextUpdate.default)(date || time, step, {
          nextStep: nextStep,
          now: now,
          future: future
        });
