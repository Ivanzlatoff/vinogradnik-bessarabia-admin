...
describe('style/round', function () {
  it('should format relative time (English)', function () {
    ...
    formatInterval(1.51 * _steps.day).should.equal('2 days ago');
    formatInterval(2.49 * _steps.day).should.equal('2 days ago');
    formatInterval(2.51 * _steps.day).should.equal('3 days ago'); // …

    formatInterval(6.49 * _steps.day).should.equal('6 days ago');
    formatInterval(6.51 * _steps.day).should.equal('1 week ago'); // …
    ...
    formatInterval(1.51 * _steps.month).should.equal('2 months ago');
    formatInterval(2.49 * _steps.month).should.equal('2 months ago');
    formatInterval(2.51 * _steps.month).should.equal('3 months ago'); // …

    formatInterval(11.49 * _steps.month).should.equal('11 months ago');
    formatInterval(11.51 * _steps.month).should.equal('1 year ago');
    formatInterval(1.49 * _steps.year).should.equal('1 year ago');
    formatInterval(1.51 * _steps.year).should.equal('2 years ago'); // …
    // Test future dates.

    formatInterval(-1 * 3).should.equal('in 3 seconds');
    formatInterval(-1 * _steps.month * 8).should.equal('in 8 months');
  });
  it('should return correct update interval', function () {
    var timeAgo = new _TimeAgo.default('en');
