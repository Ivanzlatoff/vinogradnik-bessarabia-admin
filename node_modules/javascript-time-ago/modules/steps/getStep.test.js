...
describe('getStep', function () {
  ...
  it('should throw if a non-first step does not have a `minTime` or `test()`', function () {
    expect(getStep([{
      unit: 'second'
    }], 2, {
      units: ['second']
    ...
    }).to.throw('Each step must define either `minTime` or `test()`, except for the first one. Got "undefined", undefined. Step: {"unit":"minute"}');
  });
